...
import netmod.image.imageprocessing as ip
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bGray = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.bGray.sizePolicy().hasHeightForWidth())
        self.bGray.setSizePolicy(sizePolicy)
        self.bGray.setObjectName("bGray")
        self.verticalLayout_3.addWidget(self.bGray)
        self.bSharp = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.bSharp.sizePolicy().hasHeightForWidth())
        self.bSharp.setSizePolicy(sizePolicy)
        self.bSharp.setObjectName("bSharp")
        self.verticalLayout_3.addWidget(self.bSharp)
        self.bSmooth = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.bSmooth.sizePolicy().hasHeightForWidth())
        self.bSmooth.setSizePolicy(sizePolicy)
        self.bSmooth.setObjectName("bSmooth")
        self.verticalLayout_3.addWidget(self.bSmooth)
        self.bEdge = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.bEdge.sizePolicy().hasHeightForWidth())
        self.bEdge.setSizePolicy(sizePolicy)
        self.bEdge.setObjectName("bEdge")
        self.verticalLayout_3.addWidget(self.bEdge)
        self.bHistEq = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.bHistEq.sizePolicy().hasHeightForWidth())
        self.bHistEq.setSizePolicy(sizePolicy)
...
# update window on slider change
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "NIV"))
        ...
        # self.label_5.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:6pt;\">Designed &amp; </span></p><p><span style=\" font-size:6pt;\">Developed by:</span></p><p><span style=\" font-size:6pt; font-weight:600;\">Rounak Paul</span></p><p><a href=\"www.net-work.in\"><span style=\" font-size:6pt; text-decoration: underline; color:#0000ff;\">www.net-work.in</span></a></p></body></html>"))
